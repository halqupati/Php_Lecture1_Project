...
<html>
<head>
	<title>Kown Solution website Template</title>
...
<body>
	...
	<button style="background-color:white;border: none">
       <a  style="padding: 20px;" href="http://www.localhost/kown1/register.php">Register</a>	
	</button>
</div>
<div style="text-align: center">
<img style="width: 30%;height: 30%;padding: 20px;border-radius: 20%" src="image2.jpg">	
</div>
